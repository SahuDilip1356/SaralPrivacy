...
export const metadata: Metadata = { title: "Terms of Use | DPDPAIndia" };
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="bg-brand-700 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-slate-300 mt-2">Last updated: January 2025</p>
        </div>
      </div>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
        <div className="space-y-6">
          {[
            { title: "1. Educational Purpose", content: "DPDPAIndia provides educational and informational content about the Digital Personal Data Protection Act, 2023. Nothing on this platform constitutes formal legal advice. Users should consult a qualified data protection lawyer for formal legal opinions specific to their situation." },
            ...
            { title: "3. Limitation of Liability", content: "DPDPAIndia is not liable for any losses or damages arising from reliance on content published on this platform. Users rely on this content at their own risk and should independently verify any compliance steps before implementing them." },
            { title: "4. Intellectual Property", content: "All content on this platform — including briefings, guides, templates, and assessments — is the intellectual property of DPDPAIndia. Content may be used for internal educational purposes. Reproduction or distribution for commercial purposes requires written permission." },
        ...
        <div className="mt-6 text-sm text-slate-500">
          ...
          <a href="mailto:hello@dpdpaindia.in" className="text-saffron-500 hover:underline">hello@dpdpaindia.in</a>
        </div>
      </div>
    </div>
  );
