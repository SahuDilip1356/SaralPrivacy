          ...
          <div className="space-y-5">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5">
              ...
              <div className="space-y-3">
                <a
                  href="mailto:hello@dpdpaindia.in"
                ...
                >
                  ...
                  privacy@dpdpaindia.in (data requests)
                </a>
              </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="bg-slate-50 rounded-xl p-4 border border-slate-200">
                    ...
                    <Checkbox
                      label={
                        <span>
                          I consent to DPDPAIndia contacting me via my chosen method to discuss my
                    ...
                    <p className="text-xs text-slate-400 mt-2 pl-7">
                      ...
                      You can withdraw this consent by emailing privacy@dpdpaindia.in.
                    </p>
                  </div>
