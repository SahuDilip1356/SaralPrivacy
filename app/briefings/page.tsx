...
export default function BriefingsPage() {
  ...
  const featured = sortedBriefings.find((b) => b.featured);
  const rest = sortedBriefings.filter((b) => !b.featured);
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
              ...
              <Card hover padding="none" className="h-full">
                <div className="p-6 flex flex-col h-full">
                  ...
                  <div className="flex flex-wrap gap-1 mb-3">
                    {briefing.industries.slice(0, 2).map((ind) => (
                      <span
                        key={ind}
        ...
        {/* Subscribe CTA */}
        <div className="mt-12 bg-saffron-50 border border-saffron-200 rounded-xl p-7 text-center">
          <h3 className="font-bold text-brand-700 text-xl mb-2">
            Get briefings delivered to your inbox
          </h3>
          <p className="text-slate-600 mb-5">
            Daily or weekly — choose your cadence. Unsubscribe any time.
          </p>
          <Link
            href="/#newsletter"
            className="inline-flex items-center gap-2 px-6 py-3 bg-saffron-500 text-white font-semibold rounded-lg hover:bg-saffron-600 transition-colors text-sm"
          >
            Subscribe Free
            <ArrowRight size={16} />
          </Link>
