        ...
        <div className="bg-navy-700 py-14">
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center">
              <Link href="/assessment/schools-colleges" className="inline-flex items-center justify-center gap-2 rounded-xl bg-green-500 px-6 py-3 font-semibold text-white transition-colors hover:bg-green-600">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div className="space-y-10 lg:col-span-2">
              ...
              <section className="answer-block">
                <h2 className="text-2xl font-bold text-navy-700">School & college DPDPA questions</h2>
            ...
            <div className="space-y-5">
              <div className="rounded-xl bg-teal-700 p-5 text-white">
                ...
                <p className="mt-2 text-sm text-teal-100">10 questions · 3 minutes · free · no login. Get your school or college&apos;s DPDPA readiness score.</p>
              ...
              <div className="rounded-xl border border-slate-200 bg-white p-5">
                ...
                <div className="space-y-2">
                  ...
                  <Link href="/briefings/training-institutes-student-data-dpdpa" className="block text-sm text-green-600 hover:underline">→ Student Data &amp; the DPDPA</Link>
                </div>
              </div>
