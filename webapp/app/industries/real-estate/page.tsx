        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div className="space-y-10 lg:col-span-2">
              {/* Risk map */}
              <section>
                <h2 className="text-2xl font-bold text-navy-700">Your client &amp; property-data risk map</h2>
              ...
              <section className="answer-block">
                <h2 className="text-2xl font-bold text-navy-700">Real estate DPDPA questions</h2>
