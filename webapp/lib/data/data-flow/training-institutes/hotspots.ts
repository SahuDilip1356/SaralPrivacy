...
export const TRAINING_INSTITUTES_HOTSPOTS: FlowHotspot[] = [
  ...
  },
  {
    id: "hs-printed-marks",
    rank: 5,
    nodeId: "printed-marks",
    title: "Marks and ranks displayed for everyone to see",
    whatHappens: "Result and rank sheets are pinned to notice boards or posted in groups, naming each student against their marks.",
    whyItMatters: "It discloses one student's performance to everyone else, and the labels become inaccurate permanent records the student has no way to correct.",
    dataCategoryIds: ["assessment-performance", "student-identity"],
    action: "Share results individually, drop public rank lists that identify students, and allow correction of an inaccurate record.",
    assessmentBucket: "student_data_collection",
  },
  {
