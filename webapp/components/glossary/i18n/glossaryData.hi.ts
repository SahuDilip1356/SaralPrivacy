...
const hi: GlossaryOverlay = {
  terms: {
    ...
    "de-identified-data": {
      ...
      definition:
        "ऐसा व्यक्तिगत डेटा जिससे Data Fiduciary ने वे साधन हटा दिए हैं जिनसे उस डेटा को किसी ख़ास Data Principal से जोड़ा जा सके। Section 17(3) के तहत, जब पहचान हटाया गया डेटा किसी Data Processor के साथ इस अनुबंधीय शर्त पर शेयर किया जाता है कि वह डेटा की दोबारा पहचान नहीं करेगा, तो एक्ट उस डेटा के शोध, आर्काइविंग या सांख्यिकीय उद्देश्यों के लिए इस्तेमाल पर — तय सुरक्षा उपायों के साथ — रोक नहीं लगाता।",
    },
    "anonymised-data": {
    ...
    "publicly-available-data": {
      ...
      definition:
        "ऐसा व्यक्तिगत डेटा जिसे Data Principal ने ख़ुद सार्वजनिक किया हो, या ऐसा व्यक्तिगत डेटा जिसे किसी लागू क़ानून के तहत प्रकाशित करना ज़रूरी हो। ऐसे डेटा की प्रोसेसिंग के लिए Section 4 के तहत सहमति ज़रूरी नहीं है। यह अपवाद सिर्फ़ उसी डेटा पर लागू होता है जिसे Data Principal ने अपनी मर्ज़ी से सार्वजनिक किया हो — ग़लती से या बिना अनुमति हुआ सार्वजनिक खुलासा डेटा को इस अपवाद के दायरे में नहीं लाता।",
    },
    ...
    consent: {
      localTerm: "सहमति",
      definition:
        "Data Principal की इच्छा का ऐसा संकेत जो अपनी मर्ज़ी से दिया गया हो, विशिष्ट हो, पूरी जानकारी के साथ हो, बिना शर्त हो और साफ़ हो — और जो एक स्पष्ट सकारात्मक कार्रवाई से ज़ाहिर हो। सहमति सिर्फ़ किसी तय उद्देश्य के लिए होनी चाहिए। सहमति माँगते समय या उससे पहले नोटिस देना ज़रूरी है। सहमति को ऐसे दूसरे नियम-शर्तों के साथ नहीं जोड़ा जा सकता जिनका प्रोसेसिंग के उद्देश्य से कोई संबंध न हो। हर प्रोसेसिंग के लिए सहमति ज़रूरी है, जब तक Section 7 के तहत मानी गई सहमति (deemed consent) का कोई प्रावधान लागू न हो।",
    },
    "affirmative-action": {
      localTerm: "सहमति के लिए सकारात्मक कार्रवाई",
      definition:
        "सहमति Data Principal की स्पष्ट सकारात्मक कार्रवाई से ज़ाहिर होनी चाहिए। Data Principal को अपनी मंज़ूरी दिखाने के लिए सोच-समझकर कोई सकारात्मक क़दम उठाना होगा। चुप रहना, पहले से टिक किए गए बॉक्स या कुछ न करना — एक्ट के तहत सहमति नहीं माने जाते।",
    },
    "unconditional-consent": {
      localTerm: "बिना शर्त सहमति",
      definition:
        "Section 6(1) के तहत वैध सहमति की ज़रूरी विशेषताओं में से एक। सहमति किसी दूसरे नियम या शर्त को मानने पर निर्भर नहीं होनी चाहिए। किसी सेवा को पाने की शर्त के रूप में ली गई सहमति सशर्त है और क़ानूनी मानक पर खरी नहीं उतरती।",
    },
    notice: {
    ...
    "deemed-consent": {
      ...
      definition:
        "ऐसी प्रोसेसिंग जिसके लिए Data Principal की स्पष्ट सहमति ज़रूरी नहीं है। Section 7 में आठ हालात तय हैं, और यह पूरी सूची है: (a) किसी ख़ास उद्देश्य के लिए अपनी मर्ज़ी से डेटा देना, (b) राज्य के काम, जैसे सब्सिडी, लाभ, लाइसेंस या प्रमाणपत्र, (c) किसी कोर्ट के आदेश या फ़ैसले का पालन, (d) मेडिकल इमरजेंसी या महामारी, (e) रोज़गार से जुड़ी प्रोसेसिंग, (f) जनहित के काम, (g) संप्रभुता या सुरक्षा की रक्षा, और (h) केंद्र सरकार द्वारा तय उद्देश्य। यह सूची पूरी है।",
    },
    "processing-by-state": {
    ...
    "data-minimisation": {
      ...
      definition:
        "इकट्ठा और प्रोसेस किया जाने वाला व्यक्तिगत डेटा उतना ही होना चाहिए जितना उस तय उद्देश्य के लिए ज़रूरी है जिसके लिए सहमति ली गई थी। एक्ट में ‘data minimisation’ (डेटा न्यूनतमीकरण) शब्द का इस्तेमाल नहीं हुआ है; यह दायित्व Section 8(3) से निकलता है, जिसके अनुसार डेटा तय उद्देश्य के अनुरूप और उसके लिए ज़रूरी होना चाहिए।",
    },
    "erasure-obligation": {
    ...
    "algorithmic-accountability": {
      ...
      definition:
        "Significant Data Fiduciary को एल्गोरिदम की जवाबदेही से जुड़े मानक प्रकाशित करने होते हैं। यह दायित्व सिर्फ़ उन्हीं संस्थाओं तक सीमित है जिन्हें SDF के रूप में नोटिफ़ाई किया गया है। एक्ट ‘algorithmic accountability’ (एल्गोरिदम की जवाबदेही) शब्दों का इस्तेमाल करता है — इस दायित्व से आगे एल्गोरिदम की पारदर्शिता या निष्पक्षता जैसी व्यापक अवधारणाएँ एक्ट लागू नहीं करता।",
    },
    ...
    "appellate-tribunal": {
      ...
      definition:
        "Data Protection Board के आदेशों के ख़िलाफ़ अपील Telecom Disputes Settlement and Appellate Tribunal (TDSAT) में होती है। अपील तय अवधि के भीतर दायर करनी होगी। TDSAT के फ़ैसलों के ख़िलाफ़ आगे की अपील हाई कोर्ट में होती है।",
    },
    ...
    exemptions: {
      localTerm: "छूट",
      definition:
        "एक्ट कुछ तय प्रोसेसिंग को अपने प्रावधानों से छूट देता है, जिनमें शामिल हैं: राष्ट्रीय सुरक्षा, संप्रभुता, सार्वजनिक व्यवस्था या अपराधों के लिए उकसावे की रोकथाम के लिए केंद्र सरकार द्वारा प्रोसेसिंग (Section 17(1)(a)); अपराधों की रोकथाम, पता लगाने या जाँच के लिए प्रोसेसिंग (Section 17(1)(b)); और तय सुरक्षा उपायों के साथ शोध, आर्काइविंग या सांख्यिकीय उद्देश्यों के लिए प्रोसेसिंग (Section 17(3))। केंद्र सरकार नोटिफ़िकेशन जारी करके और Data Fiduciary या Data Principal की श्रेणियों को भी छूट दे सकती है।",
    },
  ...
  categories: {
    ...
    enforcement: "प्रवर्तन और जुर्माने",
    exemptions: "छूट",
  },
};
