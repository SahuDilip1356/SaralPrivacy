...
**Status:** v1.1 (2026-08-31) — passed `/plan-eng-review` (4 amendments incorporated: §4.3 server-only resolution, §7.6 TM one-writer rule, §10.12–14 edge cases, §11.1 test matrix). Awaiting Dilip sign-off + D-1..D-5.
**Owner:** Dilip Sahu
...
## 5. Pre-i18n refactors (R1–R6) — sequenced before any translation
